...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = TweetReader.allTweets.filter(t=> google.exists(b=> t.text.contains(b)))
  lazy val appleTweets: TweetSet = TweetReader.allTweets.filter(t=> apple.exists(b => t.text.contains(b)))
